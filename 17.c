...
typedef struct { int x; int y; int z; int w; } Point;

int
points_get_neighbors_count(Point * points, int * points_count,
                           Point * target) {
  int i,x,y,z,w, result = 0;
...
solve1(char file_name[6], int cycles) {
  ...
  int x=0, y=0, z=0, w=0;
  Point points1[MAX_POINTS], points2[MAX_POINTS], neighbor;
